...
async function loadClients() {
  ...
  try {
    const response = await fetch('https://your-api-url/clients'); // Заменить на реальный URL
...
invoiceForm.addEventListener('submit', async (e) => {
  ...
  try {
    const response = await fetch('https://your-api-url/invoices', { // Заменить на реальный URL
      method: 'POST',
